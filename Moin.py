...
# --- Bot Configurations ---
TELEGRAM_BOT_TOKEN = '7747598023:AAGfi-m_9gw2L_4McP6z62OjGlbc-AavNVY'  # Replace with your actual bot token
ALLOWED_USER_ID = 1724246173  # Admin user ID
bot_access_free = True  # Set to True to make the bot free for all users
MIN_BALANCE = 1  # Minimum balance required for an attack
DEFAULT_DURATION = 300  # Default attack duration in seconds
